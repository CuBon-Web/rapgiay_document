        ...
        <div class="container">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page"><a href="{{route('lienHe')}}">Liên hệ</a></li>
                </ol>
            </nav>
        </div>
    </div>
            ...
            <div class="row g-4 mb-100">
                <div class="col-lg-5">
                    ...
                    <div class="single-contact mb-40">
                        ...
                        <div class="content">
                            <span>Email ngay</span>
                            <h6><a href="mailto:{{$setting->email}}">{{$setting->email}}</a>
                            </h6>
                        </div>
                    </div>
                    <div class="single-contact">
                        ...
                        <div class="content">
                            <span>Địa chỉ</span>
                            <h6><a>{{$setting->address1}}</a></h6>
                        </div>
                    </div>
                    <div class="service-available">
                        <span>Lưu ý:</span>
                        <p>Hỗ trợ khách hàng luôn mở từ <strong>9 giờ</strong> đến <strong>18 giờ</strong> mỗi ngày</p>
                    </div>
                </div>
                <div class="col-lg-7">
                        ...
                        <form action="{{route('postcontact')}}" method="post">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-inner mb-20">
                                        <label>Phone*</label>
                                        <input type="text" name="phone" placeholder="Ex- {{$setting->phone1}}">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-inner mb-20">
                                        <label>Email <span>(Tùy chọn)</span></label>
                                        <input type="email" name="email" placeholder="Ex- {{$setting->email}}">
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="form-inner mb-20">
                                        <label>Subject*</label>
                                        <input type="email" name="mess" placeholder="Nhập chủ đề">
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="col-md-12">
                                        <div class="form-inner">
                                            <button type="submit" class="primary-btn1 hover-btn3">Gửi</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
