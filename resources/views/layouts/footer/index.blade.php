      ...
      <div class="container">
          <div class="footer-top">
              <div class="row g-lg-4 gy-5 justify-content-center">
                  <div class="col-lg-4 col-md-4 col-sm-6 d-flex justify-content-lg-start justify-content-sm-end">
                      <div class="footer-widget">
                          <div class="widget-title">
                              <h5>Chính sách và điều khoản</h5>
                          </div>
                  ...
                  <div class="col-lg-4 col-md-4 col-sm-6 d-flex justify-content-lg-center justify-content-md-end">
                      <div class="footer-widget">
                          <div class="widget-title">
                              <h5>Sản phẩm</h5>
                          </div>
                  ...
                  <div class="col-lg-4 col-md-4 col-sm-6 d-flex justify-content-lg-center justify-content-md-start justify-content-sm-end">
                      <div class="footer-widget">
                          <div class="widget-title">
                              <h5>Map</h5>
                          </div>
              ...
              <div class="row">
                  <div class="col-lg-12 d-flex flex-md-row flex-column align-items-center justify-content-md-between justify-content-center flex-wrap gap-3">
                      <div class="footer-left">
                          <p>©Copyright 2026 {{$setting->company}} | Design By <a href="">Tuấn Anh Dev</a></p>
                      </div>
                      <div class="footer-logo">
                          <a href="{{route('home')}}"><img width="100" src="{{url($setting->logo)}}" alt=""></a>
                      </div>
